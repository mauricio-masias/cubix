...
<head>
    ...
    text-align: center;}
        ...
        @media screen and (max-width:768px){#player{display:none}.video-foreground{background:url(../img/cubix-mobile.png) center no-repeat;background-size:cover}.description{width:90%;}
            .box.b1{text-align: center;}
            .box.b2{text-align: center;}
            .box.b3{text-align: center;}  
        }</style>
